...
find_path(MKLROOT include/mkl.h PATHS $ENV{MKL_DIR} ${INTEL_ROOT}/mkl
...
if(NOT MKL_USE_SINGLE_DYNAMIC_LIBRARY)
  ...
  find_library(MKL_RTL_LIBRARY ${__iomp5_libs}
     PATHS ${INTEL_RTL_ROOT} ${INTEL_ROOT}/compiler ${MKLROOT}/.. ${MKLROOT}/../compiler
     PATH_SUFFIXES ${__path_suffixes}
